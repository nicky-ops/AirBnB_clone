...
class TestCity_instantiation(unittest.TestCase):
    """Test for instantiation of the class, City"""
    ...
    def test_str_representation(self):
        ...
        self.assertIn("'created_at': " + dtime_repr, citystr)
        self.assertIn("'updated_at': " + dtime_repr, citystr)
...
class TestCity_save(unittest.TestCase):
    """Test for save method for class City"""
...
class TestCity_to_dict(unittest.TestCase):
    """Test for to_dict method of class City"""
    ...
    def test_to_dict_output(self):
        ...
        city = City()
        city.id = "123456"
        city.created_at = cy.updated_at = dtime
        tdict = {
            'id': '123456',
            '__class__': 'City',
